...
export default function Register() {
    ...
    const checkPassword = () : boolean =>  {
        const passwordInput = document.getElementById('reenteredPassword') as HTMLInputElement;
        ...
        <>
                ...
                <form action="" >
                    ...
                    <div className="pt-5 flex flex-col">
                        ...
                        <input type="password" value={password} onChange={(event) => setPassword(event.target!.value)}  id="password" name="password" className="h-10 w-account-input pl-2 border-2 border-color-input text-black rounded-md" required />
                    </div>
                    <div className="pt-5 flex flex-col">
